# Generated by Powerlevel10k configuration wizard on 2024-03-26 at 01:56 +06.
...
# 12h time, slanted separators, slanted heads, slanted tails, 2 lines, solid,
# right frame, sparse, many icons, fluent, transient_prompt, instant_prompt=verbose.
...
() {
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=157
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=210
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=230
  ...
  typeset -g POWERLEVEL9K_ASDF_PYTHON_FOREGROUND=159
